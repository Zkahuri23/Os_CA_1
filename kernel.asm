...
801003b0:	e8 fb 02 00 00       	call   801006b0 <cprintf>
  cprintf("\n");
801003b5:	c7 04 24 9c 76 10 80 	movl   $0x8010769c,(%esp)
...
8010064b:	0f b6 92 f0 76 10 80 	movzbl -0x7fef8910(%edx),%edx
...
80101596:	e8 45 2e 00 00       	call   801043e0 <initlock>
  for(i = 0; i < NINODE; i++) {
...
801015a9:	81 c3 90 00 00 00    	add    $0x90,%ebx
    initsleeplock(&icache.inode[i].lock, "inode");
801015af:	e8 fc 2c 00 00       	call   801042b0 <initsleeplock>
  for(i = 0; i < NINODE; i++) {
...
801015dc:	e8 7f 31 00 00       	call   80104760 <memmove>
  brelse(bp);
...
80101613:	68 04 77 10 80       	push   $0x80107704
...
801016ae:	e8 1d 30 00 00       	call   801046d0 <memset>
      dip->type = type;
...
80101751:	e8 0a 30 00 00       	call   80104760 <memmove>
  log_write(bp);
...
8010177f:	e8 4c 2e 00 00       	call   801045d0 <acquire>
  ip->ref++;
80101784:	83 43 08 01          	addl   $0x1,0x8(%ebx)
  release(&icache.lock);
80101788:	c7 04 24 60 f9 10 80 	movl   $0x8010f960,(%esp)
8010178f:	e8 dc 2d 00 00       	call   80104570 <release>
}
...
801017c2:	e8 29 2b 00 00       	call   801042f0 <acquiresleep>
  if(ip->valid == 0){
...
80101838:	e8 23 2f 00 00       	call   80104760 <memmove>
    brelse(bp);
...
80101893:	e8 f8 2a 00 00       	call   80104390 <holdingsleep>
...
801018ae:	5d                   	pop    %ebp
  releasesleep(&ip->lock);
801018af:	e9 9c 2a 00 00       	jmp    80104350 <releasesleep>
    panic("iunlock");
...
801018e0:	e8 0b 2a 00 00       	call   801042f0 <acquiresleep>
...
801018fa:	e8 51 2a 00 00       	call   80104350 <releasesleep>
  acquire(&icache.lock);
801018ff:	c7 04 24 60 f9 10 80 	movl   $0x8010f960,(%esp)
80101906:	e8 c5 2c 00 00       	call   801045d0 <acquire>
  ip->ref--;
...
80101a43:	e8 48 29 00 00       	call   80104390 <holdingsleep>
...
80101a5a:	e8 f1 28 00 00       	call   80104350 <releasesleep>
  iput(ip);
...
80101b57:	e8 04 2c 00 00       	call   80104760 <memmove>
    brelse(bp);
...
80101c55:	e8 06 2b 00 00       	call   80104760 <memmove>
    log_write(bp);
...
80101dca:	e8 01 28 00 00       	call   801045d0 <acquire>
  ip->ref++;
80101dcf:	83 46 08 01          	addl   $0x1,0x8(%esi)
  release(&icache.lock);
80101dd3:	c7 04 24 60 f9 10 80 	movl   $0x8010f960,(%esp)
80101dda:	e8 91 27 00 00       	call   80104570 <release>
...
80101f25:	e8 66 24 00 00       	call   80104390 <holdingsleep>
...
80101f3c:	e8 0f 24 00 00       	call   80104350 <releasesleep>
  iput(ip);
...
80101f75:	e8 16 24 00 00       	call   80104390 <holdingsleep>
...
80101f8c:	e8 bf 23 00 00       	call   80104350 <releasesleep>
}
...
8010201d:	e8 fe 27 00 00       	call   80104820 <strncpy>
  de.inum = inum;
...
80102068:	68 a0 75 10 80       	push   $0x801075a0
...
801021b0:	e8 2b 22 00 00       	call   801043e0 <initlock>
...
8010223e:	e8 8d 23 00 00       	call   801045d0 <acquire>
...
801022bb:	e8 b0 22 00 00       	call   80104570 <release>
...
801022de:	e8 ad 20 00 00       	call   80104390 <holdingsleep>
...
80102318:	e8 b3 22 00 00       	call   801045d0 <acquire>
...
8010240a:	68 58 77 10 80       	push   $0x80107758
...
801024d2:	e8 f9 21 00 00       	call   801046d0 <memset>
...
80102508:	e8 c3 20 00 00       	call   801045d0 <acquire>
...
80102522:	c9                   	leave
    release(&kmem.lock);
80102523:	e9 48 20 00 00       	jmp    80104570 <release>
    panic("kfree");
...
80102605:	e8 d6 1d 00 00       	call   801043e0 <initlock>
  p = (char*)PGROUNDUP((uint)vstart);
...
80102698:	e8 33 1f 00 00       	call   801045d0 <acquire>
  r = kmem.freelist;
...
801026c3:	e8 a8 1e 00 00       	call   80104570 <release>
}
...
80102ad3:	e8 38 1c 00 00       	call   80104710 <memcmp>
...
80102c04:	e8 57 1b 00 00       	call   80104760 <memmove>
...
80102cb4:	e8 27 17 00 00       	call   801043e0 <initlock>
  readsb(dev, &sb);
80102cb9:	58                   	pop    %eax
...
80102d4b:	e8 80 18 00 00       	call   801045d0 <acquire>
...
80102e16:	e8 b5 17 00 00       	call   801045d0 <acquire>
    log.committing = 0;
...
80102e38:	e8 33 17 00 00       	call   80104570 <release>
...
80102e94:	e8 c7 18 00 00       	call   80104760 <memmove>
...
80102ef4:	e8 77 16 00 00       	call   80104570 <release>
...
80102f98:	c9                   	leave
  release(&log.lock);
80102f99:	e9 d2 15 00 00       	jmp    80104570 <release>
...
80102ff2:	c7 04 24 cf 73 10 80 	movl   $0x801073cf,(%esp)
80102ff9:	e8 b2 d6 ff ff       	call   801006b0 <cprintf>
  cprintf("1. Zahra Kahuri\n");
80102ffe:	c7 04 24 df 73 10 80 	movl   $0x801073df,(%esp)
80103005:	e8 a6 d6 ff ff       	call   801006b0 <cprintf>
  cprintf("2. Fatima Borhani\n");
8010300a:	c7 04 24 f0 73 10 80 	movl   $0x801073f0,(%esp)
80103011:	e8 9a d6 ff ff       	call   801006b0 <cprintf>
  cprintf("3. Amir mohammad Barari\n");
80103016:	c7 04 24 03 74 10 80 	movl   $0x80107403,(%esp)
...
8010304b:	e8 30 39 00 00       	call   80106980 <seginit>
  lapicinit();
80103050:	e8 8b f7 ff ff       	call   801027e0 <lapicinit>
  mpmain();
80103055:	e8 76 ff ff ff       	call   80102fd0 <mpmain>
...
801030b8:	e8 73 dd ff ff       	call   80100e30 <fileinit>
  ideinit();       // disk 
801030bd:	e8 de f0 ff ff       	call   801021a0 <ideinit>
...
80103120:	74 de                	je     80103100 <main+0xa0>
    ...
    stack = kalloc();
80103122:	e8 39 f5 ff ff       	call   80102660 <kalloc>
...
80103151:	e8 ca f7 ff ff       	call   80102920 <lapicstartap>
...
8010317d:	e8 0e f4 ff ff       	call   80102590 <kinit2>
  userinit();      // first user process
80103182:	e8 39 08 00 00       	call   801039c0 <userinit>
  mpmain();        // finish this processor's setup
80103187:	e8 44 fe ff ff       	call   80102fd0 <mpmain>
...
801031be:	68 1c 74 10 80       	push   $0x8010741c
...
80103279:	68 21 74 10 80       	push   $0x80107421
...
801033ab:	68 26 74 10 80       	push   $0x80107426
...
801033d2:	68 1c 74 10 80       	push   $0x8010741c
...
80103408:	68 8c 77 10 80       	push   $0x8010778c
...
80103479:	e8 e2 f1 ff ff       	call   80102660 <kalloc>
...
801034b0:	00 00 00 
  initlock(&p->lock, "pipe");
801034b3:	68 3e 74 10 80       	push   $0x8010743e
...
801035a4:	5d                   	pop    %ebp
    kfree((char*)p);
801035a5:	e9 f6 ee ff ff       	jmp    801024a0 <kfree>
...
80103827:	e8 34 ee ff ff       	call   80102660 <kalloc>
...
801038f6:	68 43 74 10 80       	push   $0x80107443
...
80103a5f:	68 73 74 10 80       	push   $0x80107473
...
80103aa3:	68 5a 74 10 80       	push   $0x8010745a
...
80103ead:	68 cb 74 10 80       	push   $0x801074cb
80103eb2:	e8 c9 c4 ff ff       	call   80100380 <panic>
    panic("init exiting");
80103eb7:	83 ec 0c             	sub    $0xc,%esp
80103eba:	68 be 74 10 80       	push   $0x801074be
...
80103ff0:	68 d7 74 10 80       	push   $0x801074d7
...
801040f9:	68 dd 74 10 80       	push   $0x801074dd
801040fe:	e8 7d c2 ff ff       	call   80100380 <panic>
    panic("sleep");
80104103:	83 ec 0c             	sub    $0xc,%esp
80104106:	68 d7 74 10 80       	push   $0x801074d7
...
8010420b:	68 9c 76 10 80       	push   $0x8010769c
...
8010422c:	74 ea                	je     80104218 <procdump+0x28>
      state = "???";
8010422e:	ba ee 74 10 80       	mov    $0x801074ee,%edx
    if(p->state >= 0 && p->state < NELEM(states) && states[p->state])
80104233:	83 f8 05             	cmp    $0x5,%eax
80104236:	77 11                	ja     80104249 <procdump+0x59>
80104238:	8b 14 85 c0 7a 10 80 	mov    -0x7fef8540(,%eax,4),%edx
      state = "???";
8010423f:	b8 ee 74 10 80       	mov    $0x801074ee,%eax
...
8010424e:	68 f2 74 10 80       	push   $0x801074f2
...
801042ba:	68 25 75 10 80       	push   $0x80107525
...
80104515:	68 30 75 10 80       	push   $0x80107530
8010451a:	e8 61 be ff ff       	call   80100380 <panic>
    panic("popcli");
8010451f:	83 ec 0c             	sub    $0xc,%esp
80104522:	68 47 75 10 80       	push   $0x80107547
...
8010458b:	68 4e 75 10 80       	push   $0x8010754e
...
801046b8:	68 56 75 10 80       	push   $0x80107556
...
80104adc:	8b 14 85 e0 7a 10 80 	mov    -0x7fef8520(,%eax,4),%edx
...
80104b08:	68 5e 75 10 80       	push   $0x8010755e
...
80104c54:	68 96 75 10 80       	push   $0x80107596
...
80104c6c:	68 95 75 10 80       	push   $0x80107595
...
8010508d:	58                   	pop    %eax
8010508e:	5a                   	pop    %edx
8010508f:	68 96 75 10 80       	push   $0x80107596
...
801050a8:	68 95 75 10 80       	push   $0x80107595
...
801058de:	00 00 ef 
  initlock(&tickslock, "time");
801058e1:	68 db 75 10 80       	push   $0x801075db
...
80105964:	ff 24 85 38 7b 10 80 	jmp    *-0x7fef84c8(,%eax,4)
8010596b:	2e 8d 74 26 00       	lea    %cs:0x0(%esi,%eiz,1),%esi
  ...
  case T_IRQ0 + IRQ_IDE:
    ideintr();
80105970:	e8 bb c8 ff ff       	call   80102230 <ideintr>
    lapiceoi();
80105975:	e8 76 cf ff ff       	call   801028f0 <lapiceoi>
  }
...
80105a35:	68 2c 78 10 80       	push   $0x8010782c
...
80105a87:	68 d4 77 10 80       	push   $0x801077d4
80105a8c:	e8 1f ac ff ff       	call   801006b0 <cprintf>
    lapiceoi();
80105a91:	e8 5a ce ff ff       	call   801028f0 <lapiceoi>
    break;
...
80105b0c:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
    kbdintr();
80105b10:	e8 ab cc ff ff       	call   801027c0 <kbdintr>
    lapiceoi();
...
80105ba3:	68 f8 77 10 80       	push   $0x801077f8
80105ba8:	e8 03 ab ff ff       	call   801006b0 <cprintf>
      panic("trap");
80105bad:	83 c4 14             	add    $0x14,%esp
80105bb0:	68 e0 75 10 80       	push   $0x801075e0
...
80105c60:	83 ec 08             	sub    $0x8,%esp
  for(p="xv6...\n"; *p; p++)
80105c63:	bf e5 75 10 80       	mov    $0x801075e5,%edi
80105c68:	be fd 03 00 00       	mov    $0x3fd,%esi
  ioapicenable(IRQ_COM1, 0);
80105c6d:	6a 00                	push   $0x0
80105c6f:	6a 04                	push   $0x4
80105c71:	e8 ea c7 ff ff       	call   80102460 <ioapicenable>
...
80105c9d:	e8 6e cc ff ff       	call   80102910 <microdelay>
  for(i = 0; i < 128 && !(inb(COM1+5) & 0x20); i++)
...
80105d0d:	e8 fe cb ff ff       	call   80102910 <microdelay>
  for(i = 0; i < 128 && !(inb(COM1+5) & 0x20); i++)
...
8010686b:	e8 30 bc ff ff       	call   801024a0 <kfree>
      *pte = 0;
...
80106910:	e8 4b bd ff ff       	call   80102660 <kalloc>
...
8010696d:	68 ed 75 10 80       	push   $0x801075ed
...
80106b4b:	77 49                	ja     80106b96 <inituvm+0x66>
  mem = kalloc();
80106b4d:	e8 0e bb ff ff       	call   80102660 <kalloc>
  memset(mem, 0, PGSIZE);
...
80106b99:	68 32 76 10 80       	push   $0x80107632
...
80106be8:	68 4c 76 10 80       	push   $0x8010764c
...
80106c36:	e8 75 ae ff ff       	call   80101ab0 <readi>
...
80106c70:	68 70 78 10 80       	push   $0x80107870
...
80106cf9:	0f 83 89 00 00 00    	jae    80106d88 <allocuvm+0x108>
    mem = kalloc();
80106cff:	e8 5c b9 ff ff       	call   80102660 <kalloc>
...
80106d0d:	68 6a 76 10 80       	push   $0x8010766a
...
80106d53:	68 82 76 10 80       	push   $0x80107682
...
80106d76:	e8 25 b7 ff ff       	call   801024a0 <kfree>
      return 0;
...
80106e1e:	e8 7d b6 ff ff       	call   801024a0 <kfree>
...
80106e33:	5d                   	pop    %ebp
  kfree((char*)pgdir);
80106e34:	e9 67 b6 ff ff       	jmp    801024a0 <kfree>
    panic("freevm: no pgdir");
80106e39:	83 ec 0c             	sub    $0xc,%esp
80106e3c:	68 9e 76 10 80       	push   $0x8010769e
...
80106e55:	e8 06 b8 ff ff       	call   80102660 <kalloc>
...
80106f0c:	68 af 76 10 80       	push   $0x801076af
...
80106f82:	68 b9 76 10 80       	push   $0x801076b9
...
80106fbf:	81 e7 00 f0 ff ff    	and    $0xfffff000,%edi
    if((mem = kalloc()) == 0)
80106fc5:	e8 96 b6 ff ff       	call   80102660 <kalloc>
...
8010702c:	e8 6f b4 ff ff       	call   801024a0 <kfree>
      goto bad;
...
80107057:	68 d3 76 10 80       	push   $0x801076d3
